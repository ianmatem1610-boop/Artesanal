...
public class Maquina {
    ...
    public void imprimir() {
        String mensaje = "Codigo: " + codigo + " , NombreCerveza: " + nombreCerveza + " , Descripcion: " + descripcion 
                + " , Precio po Ml: " + precioPorMl + " , Capacidad Maxima: " + capacidadMaxima + " , Cantidad Actual: " + cantidadActual;
